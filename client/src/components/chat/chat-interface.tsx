...
export default function ChatInterface() {
  ...
  return (
    <div className="flex flex-col h-full max-h-screen overflow-hidden chat-container">
      {/* Chat Header - Compact */}
      <div className="bg-card border-b border-border border-l border-border backdrop-blur-sm px-4 py-3 lg:px-6 lg:py-4 bg-gradient-to-r from-card/90 to-muted/20 sticky top-0 z-20">
      ...
      <div className="flex-1 overflow-y-auto message-area relative z-10 border-l border-border">
      ...
      <div className="bg-card border-t border-border border-l border-border backdrop-blur-sm px-4 py-3 lg:px-6 lg:py-4 flex-shrink-0 sticky bottom-0 z-20">
